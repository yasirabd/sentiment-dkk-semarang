...
if menu_choice == 'Data Annotation':
    ...
    '''
    Proses melakukan anotasi label menggunakan `doccano` seperti video di bawah.
    '''
    ...
    '''
    df_label_composition = pd.DataFrame([['neutral', 3127],['positive', 2620], ['negative', 3345]], columns=['sentiment', 'frequency'])
    col1, col2 = st.columns(2)
    with col1:
